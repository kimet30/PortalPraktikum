              ...
              <div class="form-group">
                            <select  id="semester" class="form-control" >
                                ...
                                foreach ($_semester as $key => $semester) {?>
                                  <option value="<?php echo $semester['id_semester']?>" selected ><?php echo $semester['semester']?></option>  
                                  <?php
                                }
                                $param=$semester['id_semester'];
                                ?>
                            </select>
                        </div>
                        ...
                        <?php foreach ($_mengambil as $key => $mengambil) {
                          foreach ($_matakuliah as $key => $matakuliah) {
                           ...
                           ?>
                             <li  ><a href="<?= base_url();?>post/<?php echo $matakuliah['id_matkul']?>"><i class="fa "></i> <?php echo $matakuliah['nama_matkul'];?></a></li>
                           <?php
                            }
                          }
                        }?>
        ...
        <br /><br />
            ...
            <div class="tab-content">
              ...
              <?php 
                foreach ($_mengerjakan_tugas as $key => $mengerjakan_tugas) {
                  foreach ($_tugas as $key => $tugas) {
                    if($mahasiswa['npm']==$mengerjakan_tugas['npm']&&$mengerjakan_tugas['id_semester']==$semester['id_semester']&&$mengerjakan_tugas['id_tugas']==$tugas['id_tugas']&&$mengerjakan_tugas['status']==0&&$tugas['kategori']!='post'){
                      ?>
             ...
             $tiga=0;
                foreach ($_mengerjakan_tugas as $key => $mengerjakan_tugas) {
                  foreach ($_tugas as $key => $tugas) {
                    if($mahasiswa['npm']==$mengerjakan_tugas['npm']&&$mengerjakan_tugas['id_semester']==$semester['id_semester']&&$mengerjakan_tugas['id_tugas']==$tugas['id_tugas']&&$mengerjakan_tugas['status']==1&&$tiga!=3){
                      
                    echo "<a type='button' data-toggle='collapse' data-target=''>";
                    echo "<div class='btn-toolbar well well-sm' role='toolbar'  style='margin:0px';>";
                      echo "<div class='btn-group col-md-4'><input type='checkbox'>";echo $tugas['nama_tugas'];echo "</div>";
                      echo "<div class='btn-group col-md-6'><b>Completed</b> <div class='pull-right'><i class='glyphicon glyphicon-time'> </i>";  echo $mengerjakan_tugas['tanggal_kirim'];echo "</div> </div>";
                    echo "</div>";
                echo "</a>";
                $tiga++;
            ...
            <div class="panel with-nav-tabs panel-default">
                <div class="panel-heading">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tugas" data-toggle="tab"><span class="glyphicon glyphicon-list-alt"></span> Daftar Tugas</a></li>
                        <li><a href="#absen" data-toggle="tab"><span class="glyphicon glyphicon-ok-sign"></span> Absensi</a></li>
                        <li><a href="#nilai" data-toggle="tab"><span class="glyphicon glyphicon-stats"></span> Nilai</a></li>
                        <li><a href="#jadwal" data-toggle="tab"><span class="glyphicon glyphicon-calendar"></span> Jadwal </a></li>
                        <li><a href="#history" data-toggle="tab"> <span class="glyphicon glyphicon-repeat"></span> Tugas Yang Dikirim</a></li>
                        <li><a href="#JQuery" data-toggle="tab"> <span class="glyphicon glyphicon-font"></span> Asisten Praktikum</a></li>
                    </ul>
                </div>
                        ...
                        <div class="tab-pane fade in active" id="tugas">
                            ...
                            <!-- Blog Entries Column -->
                                ...
                                <?php foreach ($_tugas as $tugas ){
                                    ...
                                    <p >by <a href="index.php" style="text-decoration:none"><?php echo $assistant['nama']; ?></a></p>
                            ...
                            <!-- Blog Sidebar Widgets Column -->
                                    ...
                                    <div class="row"><br /><br /></div>
                                        <div class="well">
                                                ...
                                                <div class="input-group form-g">
                                                    <input type="text" name="pencarian" placeholder="Type for search "class="form-control">
                                                    <br /><br />
                                                    <button class="btn btn-default" align="center"type="submit" value="cari"><span class="glyphicon glyphicon-search"></span> Search </button>
                                                </div>
                                                </form>
                                                    ...
                                                    <table class="table table-striped table-bordered table-list">
                                                        ...
                                                        <tbody>
                                                         ...
                                                         foreach ($_absen as $key => $absen) {
                                                                foreach ($_matakuliah as $key => $matakuliah) {
                                                                    if($absen['npm']==$mahasiswa['npm']&&$absen['id_semester']==$param&&$absen['id_matkul']==$matakuliah['id_matkul']){
                                                                        ?>
                                                            <tr>
                                                    ...
                                                    <?php 
                                                    	foreach ($_mengerjakan_tugas as $key => $mengerjakan_tugas) {
                                                    		if($mengerjakan_tugas['npm']==$mahasiswa['npm']&&$mengerjakan_tugas['id_semester']==$param){
                                                    			foreach ($_tugas as $key => $tugas) {
                                                    				if($tugas['id_tugas']==$mengerjakan_tugas['id_tugas']&&$mengerjakan_tugas['status']==0&&$tugas['kategori']!='post'){
                                                    					?>
                                                        <tr>
                                                            <td><?php echo $no;$no++;?></td>
                                            ...
                                            <li class="<?php if($no%2!=0){echo "timeline";$no++;}else{echo "timeline-inverted";$no++;}?>">
                                                ...
                                                <div class="timeline-panel">
                                                    <div class="timeline-heading">
                                                        ...
                                                        <h5 class="subheading"><?php echo $matakuliah['nama_matkul']?></h5>
                                                    </div>
